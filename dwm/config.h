...
static const char *bashtop[]  = { "htop", NULL };
static const char *termcmd[] = {"gnome-terminal", NULL};
static const char *firefox[] = {"firefox", NULL};
static const char *upvol[]   = { "amixer", "-q", "set", "Master", "5%+", "unmute", NULL };
static const char *downvol[] = { "amixer", "-q", "set", "Master", "5%-", "unmute", NULL };
static const char *mutevol[] = { "amixer", "-q", "set", "Master", "toggle", NULL };
static const char *upbacklight[] = {"xbacklight", "+5", NULL};
static const char *downbacklight[] = {"xbacklight", "-5", NULL};
...
static Key keys[] = {
	...
	// KEY BINDINGS RELATED TO MY LAPTOP MSI
	{ NULL,						0x1008ff12,    spawn,	   { .v = mutevol} },
	{ NULL,				   	0x1008ff13,  spawn,	   { .v = upvol} },
	{ NULL,				   0x1008ff11,   spawn,	   { .v = downvol} },
	{ NULL,					   0x1008ff02,     spawn,	   { .v = upbacklight} },
	{ NULL,					   0x1008ff03,   spawn,	   { .v = downbacklight} },
	
	{ MODKEY,						XK_space,  spawn,	   { .v = pauseTrack} },
	{ MODKEY,						XK_less,   spawn,	   { .v = nextTrack} },
	{ MODKEY|ShiftMask,				XK_less,   spawn,	   { .v = prevTrack} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
